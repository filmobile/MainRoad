...
namespace WindowsFormsApplication354
{
    ...
    public static class TopologyHelper
    {
        ...
        public static bool IsInside(this IEnumerable<TopologyHelper.Point> cells1, IEnumerable<TopologyHelper.Point> cells2)
        {
            var hash = new HashSet<TopologyHelper.Point>(cells1);
